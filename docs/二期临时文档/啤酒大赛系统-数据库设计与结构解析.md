...
- 存储引擎：`InnoDB`；排序规则：`utf8mb4_0900_ai_ci`；字段数：12；索引数：3。
- 本地快照行数（估计）：6。
...
|---:|---|---|---|---|---|---|---|
| 1 | `id` | `bigint` | 否 | — | 主键 | 自增 | 主键ID |
| 2 | `organizer_id` | `bigint` | 否 | — | 普通索引 | — | 所属主办方，啤酒事务局为平台组织 |
| 3 | `visibility` | `varchar(16)` | 否 | PRIVATE | — | — | PUBLIC 公共库，PRIVATE 内部库 |
| 4 | `code` | `varchar(64)` | 否 | — | 唯一索引 | — | 风格库编码 |
| 5 | `name` | `varchar(128)` | 否 | — | — | — | 风格库名称 |
| 6 | `version` | `varchar(64)` | 否 | — | — | — | 风格库版本 |
| 7 | `language` | `varchar(32)` | 否 | — | — | — | 语言 |
| 8 | `source` | `varchar(64)` | 否 | — | — | — | 来源 |
| 9 | `status` | `tinyint` | 否 | 1 | — | — | 风格库启用状态 |
| 10 | `tags_json` | `json` | 是 | — | — | — | 标签JSON |
...
| `idx_style_library_organizer` | 普通索引 | `organizer_id` | `BTREE` |
