...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'beer-coins', component: () => import('@/views/admin/BeerCoins.vue'), meta: { adminTypes: [ADMIN_TYPES.PLATFORM_SUPER_ADMIN, ADMIN_TYPES.ORGANIZER_ADMIN, ADMIN_TYPES.ORGANIZER_SUB_ADMIN] } },
